export default {
  ops: {
    ...
    runtime: {
      ...
      metricThresholdsHint: '当某项指标在评估窗口内超过阈值时触发预警。',
      requestErrorRateMaxPercent: '最大请求错误率 (%)',
      requestErrorRateMaxPercentHint: '请求错误率超过该百分比时触发预警。',
      slaMinPercent: '最低 SLA (%)',
      slaMinPercentHint: '成功率（SLA）低于该百分比时触发预警。',
      ttftP99MaxMs: '最大 TTFT P99 (ms)',
      ttftP99MaxMsHint: 'P99 首字延迟超过该毫秒数时触发预警。',
      upstreamErrorRateMaxPercent: '最大上游错误率 (%)',
      upstreamErrorRateMaxPercentHint: '上游错误率超过该百分比时触发预警。'
    },
    email: {
      title: '邮件通知配置',
