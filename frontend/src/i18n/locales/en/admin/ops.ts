export default {
  ops: {
    ...
    runtime: {
      ...
      metricThresholdsHint: 'Alerts fire when a metric crosses its threshold within the evaluation window.',
      requestErrorRateMaxPercent: 'Max Request Error Rate (%)',
      requestErrorRateMaxPercentHint: 'Alert when the request error rate exceeds this percentage.',
      slaMinPercent: 'Min SLA (%)',
      slaMinPercentHint: 'Alert when the success rate (SLA) drops below this percentage.',
      ttftP99MaxMs: 'Max TTFT P99 (ms)',
      ttftP99MaxMsHint: 'Alert when the P99 time-to-first-token exceeds this many milliseconds.',
      upstreamErrorRateMaxPercent: 'Max Upstream Error Rate (%)',
      upstreamErrorRateMaxPercentHint: 'Alert when the upstream error rate exceeds this percentage.'
    },
    email: {
