export default {
    accounts: {
      ...
      vertexRegion: 'Region',
      vertexRegionHint: 'Vertex AI region — model availability varies (see GCP docs). Use "global" for multi-region routing.',
      vertexServiceAccountJson: 'Service Account JSON',
      vertexServiceAccountJsonHint: 'Service Account key JSON downloaded from GCP Console (paste the full content; stored encrypted).',
      ...
      batchBedrock: {
        ...
        apiKeyHint: 'One account-wide key; it is fanned out to every selected region.',
        ...
        geoGroup: 'Geo group',
        geoProfile: 'Geo (us./eu./apac.)',
        globalGroup: 'Global group',
        globalOnly: 'global only',
        globalProfile: 'Global (global.)',
        group: 'Group (pool)',
        groupHint: 'All accounts share one group + equal priority so the gateway load-balances across regions.',
        import: 'Import {count}',
        importing: 'Importing…',
        invert: 'Invert',
        loadFactor: 'Load factor',
        menuTitle: 'Batch import Bedrock (all regions)',
        namePrefix: 'Name prefix',
        noGroup: '— none —',
        noGroupWarning: 'No group selected — these accounts will not be load-balanced as a pool.',
        nonBedrockRegionHint: 'Not all AWS regions serve Bedrock Claude; unsupported regions fail at request time.',
        priority: 'Priority (same for all)',
        profiles: 'Cross-region profiles',
        regions: 'Regions',
        ...
        selectedCount: '{count} selected',
        splitGroups: 'Put Geo and Global in separate groups',
        title: 'Batch Import Bedrock (all regions)',
        willCreate: 'Will create {count} accounts ({regions} regions × {profiles} profiles).'
      },
      upstreamPassthrough: {
        advancedHelp: 'Each toggle defaults to "Inherit". Click to flip to "Force ON" or "Force OFF".',
        advancedTitle: 'Advanced (per-toggle override)',
        baseRpmHint: '0 = unlimited. Official accounts ≤200; reverse accounts ≤50.',
        category: 'Account category',
        categoryAuto: 'Auto (derived: {derived})',
        categoryDerivedBadge: 'derived',
        categoryOfficial: 'Official direct',
        categoryOverrideLabel: 'Override category',
        categoryRelay: 'Relay',
        categoryReverse: 'Reverse client',
        categoryReverseWarn: '⚠ Reverse-client accounts default to Strict mimic. Loosen with care.',
        concurrencyHint: 'Relay: usually 10+; official: ≤3; reverse: ≤2',
        description: 'Fine-tune passthrough/protection for this account on top of system defaults.',
        finalEffectiveCollapse: 'Hide',
        finalEffectiveExpand: 'Show 7 toggle values',
        finalEffectiveOverrideCount: '{count} override(s)',
        finalEffectiveTitle: '📍 Effective policy',
        killSwitchActive: '⚠ Global kill switch is active — account settings are overridden',
        profileInherit: 'Inherit category default ({profile})',
        ...
        recommendedFor: 'Recommended: {value} ({category})',
        title: 'Upstream Passthrough Policy',
        tristateInherit: 'Inherit',
        tristateOff: 'Force OFF',
        tristateOn: 'Force ON'
      },
      messages: {
        accountCreated: 'Account created successfully'
