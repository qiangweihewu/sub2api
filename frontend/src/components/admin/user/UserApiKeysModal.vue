            ...
            <div class="flex items-center gap-1">
              ...
              <button
                ...
                :class="[
                  ...
                  isReadonlyAdmin ? '' : 'cursor-pointer hover:bg-gray-100 dark:hover:bg-dark-700'
                ]"
                :disabled="updatingKeyIds.has(key.id) || isReadonlyAdmin"
              >
                <GroupBadge
                ...
                <svg v-else-if="!isReadonlyAdmin" class="h-3 w-3 text-gray-400" fill="none" stroke="currentColor" viewBox="0 0 24 24" stroke-width="2"><path stroke-linecap="round" stroke-linejoin="round" d="M8.25 15L12 18.75 15.75 15m-7.5-6L12 5.25 15.75 9" /></svg>
              </button>
            </div>
