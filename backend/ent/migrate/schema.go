...
var (
	...
	APIKeysColumns = []*schema.Column{
		...
		{Name: "cache_strategy", Type: field.TypeString, Size: 32, Default: "auto"},
		{Name: "model_rate_limits", Type: field.TypeJSON, Nullable: true, SchemaType: map[string]string{"postgres": "jsonb"}},
	...
	GroupsColumns = []*schema.Column{
		...
		{Name: "default_model_rate_limits", Type: field.TypeJSON, Nullable: true, SchemaType: map[string]string{"postgres": "jsonb"}},
		...
		{Name: "default_account_concurrency", Type: field.TypeInt, Default: 0},
		{Name: "default_account_rpm", Type: field.TypeInt, Default: 0},
		{Name: "default_passthrough_profile", Type: field.TypeString, Default: ""},
		{Name: "default_429_cooldown_sec", Type: field.TypeInt, Default: 0},
	...
	UsageLogsColumns = []*schema.Column{
		...
		{Name: "cache_policy_trace", Type: field.TypeString, Nullable: true, Size: 64},
		{Name: "created_at", Type: field.TypeTime, SchemaType: map[string]string{"postgres": "timestamptz"}},
	...
	UsageLogsTable = &schema.Table{
		...
		Indexes: []*schema.Index{
			...
			},
			{
				...
				Unique:  false,
				Columns: []*schema.Column{UsageLogsColumns[45], UsageLogsColumns[43]},
			},
			{
