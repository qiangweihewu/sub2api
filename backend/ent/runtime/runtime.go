...
func init() {
	...
	groupDescBatchImageDiscountMultiplier := groupFields[20].Descriptor()
	...
	groupDescBatchImageHoldMultiplier := groupFields[21].Descriptor()
	...
	groupDescDefaultAccountConcurrency := groupFields[58].Descriptor()
	...
	groupDescDefaultAccountRpm := groupFields[59].Descriptor()
	...
	groupDescDefaultPassthroughProfile := groupFields[60].Descriptor()
	...
	groupDescDefault429CooldownSec := groupFields[61].Descriptor()
	...
	usagelogDescCachePolicyTrace := usagelogFields[46].Descriptor()
