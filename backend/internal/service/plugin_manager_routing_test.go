...
// Prewarm 满足 HTTPUpstream 接口；本用例只断言 Do/DoWithTLS 的路由选择。
func (u *pluginRoutingHTTPUpstream) Prewarm(_ context.Context, _ string, _ string, _ int64, _ int, _ *tlsfingerprint.Profile) error {
	return nil
}
