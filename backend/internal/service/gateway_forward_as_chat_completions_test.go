...
func TestHandleCCBufferedFromAnthropic_ToolArgumentsAreValidJSON(t *testing.T) {
	...
	_, err := (&GatewayService{}).handleCCBufferedFromAnthropic(context.Background(), resp, c, nil, "gpt-5", "claude-sonnet-4.5", nil, time.Now())
...
func TestHandleCCBufferedFromAnthropic_CompactSSEFormat(t *testing.T) {
	...
	svc := &GatewayService{}
	result, err := svc.handleCCBufferedFromAnthropic(context.Background(), resp, c, nil, "k3", "k3", nil, time.Now())
	require.NoError(t, err)
	require.NotNil(t, result)
...
func TestHandleCCStreamingFromAnthropic_CompactSSEFormat(t *testing.T) {
	...
	svc := &GatewayService{}
	result, err := svc.handleCCStreamingFromAnthropic(context.Background(), resp, c, nil, "k3", "k3", nil, time.Now(), true)
	require.NoError(t, err)
	require.NotNil(t, result)
