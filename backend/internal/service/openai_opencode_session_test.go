...
// Prewarm 满足 HTTPUpstream 接口；本用例不走预热路径。
func (u *openCodeSessionHTTPUpstream) Prewarm(_ context.Context, _ string, _ string, _ int64, _ int, _ *tlsfingerprint.Profile) error {
	return nil
}
