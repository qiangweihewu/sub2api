...
// Prewarm 同样计入 calls：断言「策略拒绝后没有任何上游连接发起」。
func (u *recordingHTTPUpstream) Prewarm(_ context.Context, _ string, _ string, _ int64, _ int, _ *tlsfingerprint.Profile) error {
	u.calls++
